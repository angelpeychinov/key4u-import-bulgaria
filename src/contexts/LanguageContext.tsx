...
const translations = {
  en: {
    ...
    'faq.a2': 'Total cost includes car price, shipping, customs/taxes, Tehnotest, and our service fee. We provide a detailed quote upfront.',
  ...
  bg: {
    ...
    'faq.a2': 'Общата цена включва цената на колата, доставка, мита/данъци, Техноtest и нашата такса за услуга. Даваме детайлна оферта предварително.',
    'faq.q3': 'Вие се занимавате ли с регистрацията?',
    'faq.a3': 'Да! Ние се грижим за всички документи включително Техноtest, конверсии и регистрация при българските власти.',
    'faq.q4': 'Какви марки внасяте?',
    'faq.a4': 'Внасяме всички основни марки: BMW, Mercedes, Audi, Tesla, Porsche и др. Кажете ни какво искате!',
    'faq.q5': 'Мога ли да видя колата преди покупка?',
    'faq.a5': 'Предоставяме детайлни снимки, видеа и история на автомобила. Виртуални огледи също са възможни.',
