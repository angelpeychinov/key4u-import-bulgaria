...
export default function Process() {
  ...
  const steps = [
    { icon: ClipboardList, title: t('process.step1'), description: t('process.step1desc'), number: "01", accent: "primary" as const },
    { icon: Search, title: t('process.step2'), description: t('process.step2desc'), number: "02", accent: "accent" as const },
